...
class DiscriminatorTrainer:
    ...
    def train_discriminator(self, model, dp_dict, fair_disc_dict, lr_attack=None, l2_attack=None, t = None):
        """
            ...
            for epoch in range(self.disc_epoch):
                output_dict = \
                    self.fit_disc(model, train_data, fair_disc_dict, epoch=epoch,
                                  lr_attack=lr_attack, l2_attack=l2_attack, t = t)
                ...
                test_result_dict = \
                    self.evaluation_disc(model, fair_disc_dict, test_data, dp_dict['train'], t = t)
    ...
    def fit_disc(self, model, batches, fair_disc_dict, epoch=-1, lr_attack=None, l2_attack=None, t = None):
        """
        ...
        for batch in batches:
            ...
            if t is None:
                ...
                vectors = model.get_user_embedding(uids, t)
    ...
    @torch.no_grad()
    def evaluation_disc(self, model, fair_disc_dict, test_data, dp, t = None):
