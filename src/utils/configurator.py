...
class Config(object):
    ...
    def _load_dataset_model_config(self, config_dict):
        ...
        if config_dict['fairness_model'] is None:
            file_list.append(os.path.join(cur_dir, "model", "pretrain", "{}.yaml".format(config_dict['recommendation_model'])))
        else:
            file_list.append(os.path.join(cur_dir, "model", "fairness_tuning", "{}_{}_{}.yaml".format(config_dict['dataset'], config_dict['recommendation_model'], config_dict['fairness_model'])))
